...
4.1 Introduction
The GK My Halaba Hotel Management Information System (HMIS) is designed using a modern three-tier architecture to ensure scalability, maintainability, security, and high performance. The system separates the presentation layer, business logic layer, and data layer, allowing each component to operate independently while communicating seamlessly.
This architecture simplifies future maintenance, supports system expansion, and enables efficient management of hotel operations.
4.2 Architectural Overview
The system consists of three primary layers:
1. Presentation Layer
This layer provides the user interface for guests and hotel staff.
It includes:
...
•	Manager Dashboard 
•	Owner Dashboard 
Users interact with the system through modern web browsers on desktop computers, tablets, and mobile devices.
2. Business Logic Layer
This layer contains all application logic and controls system operations.
...
•	Notification Module 
The business layer validates user input, processes requests, and communicates with the database.
3. Data Layer
This layer manages all persistent information stored within the hotel system.
It includes databases for:
•	Users 
•	Guests 
•	Reservations 
•	Rooms 
...
•	Website Settings 
•	Audit Logs 
MySQL serves as the primary relational database management system.
...
4.7 System Communication Flow
The following steps describe how the system processes a typical request:
1.	A guest accesses the website. 
2.	The guest requests a room reservation. 
3.	The browser sends an HTTPS request to the web server. 
4.	The PHP backend validates the submitted information. 
...
8.	The web server sends the final response to the user's browser. 
4.8 Security Architecture
The system implements multiple security mechanisms to protect user information.
...
This chapter presented the architectural design of the GK My Halaba Hotel Management Information System. It described the three-tier architecture, major modules, system components, communication flow, deployment architecture, technology stack, security architecture, and scalability considerations. The architecture provides a reliable foundation for implementing the functional and non-functional requirements described in subsequent chapters.
